  ...
  ,admin = {
    ...
    ,theme: function(options){
      ...
      ,styleText = laytpl([
        ...
        ,'{background-color:#f5fafe !important;color:#000}'
        ...
        //logo
        ,'.layui-layout-admin .layui-logo{background-color:#2770cc !important;}'
        
        //头部色
        ,'{{# if(d.color.header){ }}'
          ,'.layui-layout-admin .layui-header{background-color:#f5fafe;}'
